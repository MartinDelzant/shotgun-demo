...
export async function getTracks(): Promise<Track[]> {
  ...
  SELECT t.id, t.name, t.duration_ms, t.image_url, t.preview_url, array_agg(a.name) as artists, utl.track_id IS NOT NULL as liked
  FROM tracks t
  ...
  GROUP BY t.id, t.name, t.duration_ms, t.image_url, t.preview_url, utl.track_id`;
